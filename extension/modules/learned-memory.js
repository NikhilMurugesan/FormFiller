...
var LearnedMemory = LearnedMemory || (() => {
  ...
  const INTENT_PATTERNS = [
    ...
    { intent: 'current_ctc',           patterns: [/\bcctc\b/i, /current.?ctc/i, /current.?salary/i, /current.?compensation/i, /present.?ctc/i, /present.?salary/i] },
    { intent: 'expected_ctc',          patterns: [/\bectc\b/i, /expected.?ctc/i, /expected.?salary/i, /expected.?compensation/i, /desired.?salary/i, /desired.?ctc/i, /salary.?expect/i, /compensation.?expect/i, /expected.?pay/i] },
    { intent: 'salary_expectation',    patterns: [/salary/i, /compensation/i, /expected.?pay/i, /desired.?salary/i, /pay.?expect/i, /ctc/i] },
