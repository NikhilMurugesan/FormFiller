...
var MappingEngine = MappingEngine || (() => {
  ...
  const SYNONYMS = {
    ...
    current_ctc: ['cctc', 'current_ctc', 'current ctc', 'current-ctc', 'current_salary', 'current salary', 'current-salary', 'current_compensation', 'current compensation', 'present_ctc', 'present ctc', 'present salary'],
    expected_ctc: ['ectc', 'expected_ctc', 'expected ctc', 'expected-ctc', 'expected_salary', 'expected salary', 'expected-salary', 'expected_compensation', 'expected compensation', 'desired_salary', 'desired salary', 'desired_ctc', 'desired ctc'],
    salary_expectation: ['salary_expectation', 'salary expectation', 'expected_salary', 'expected salary', 'expected_ctc', 'expected ctc', 'compensation', 'compensation expectation', 'expected pay'],
